...
export const DEFAULT_SETTINGS: MapSettings = { master: 1, music: 0.55, ambience: 0.8, water: 0.8, animals: 0.8, steps: 0.45, moves: 0.7, ui: 0.7, time: 'day', weather: 'season', calm: false, lang: 'km', easyFly: true };
