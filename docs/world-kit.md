...
| 20 3 | Broken statue | seated Buddha 1.31 m on a 0.28 m plinth of three courses, 1.06 × 0.63 m (head 0.44 m chin to topknot, shoulders 0.81 m and lap 0.88 m wide); guardian torso 0.9 m | not given | Khmer seated Buddhas of the Angkor Wat period are about life size, 1.2–1.4 m with the pedestal; a dvarapala guardian is ~1.8 m whole, so its torso fragment is ~0.9 m. The Buddha sheet gives no size either: its head is a third of the height and its base a fifth, so at a 0.44 m head the statue comes to 1.3 m. |
